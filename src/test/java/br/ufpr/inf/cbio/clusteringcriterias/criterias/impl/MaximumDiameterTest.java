...
public class MaximumDiameterTest {
    ...
    /**
     * Test of evaluate method, of class MaximumDiameter.
     */
    @Test
    public void testEvaluate() {
        ...
        dataset.addDataPoint("d", new ArrayPoint(new double[]{2.0, 1.0}));
        ...
        MaximumDiameter instance = new MaximumDiameter(dataset);
        double expResult = 2.0;
        double result = instance.evaluate(s);
        System.out.println("MaximumDiameter expected: " + expResult + ", actual: " + result);
