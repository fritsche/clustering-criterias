package br.ufpr.inf.cbio.clusteringcriterias.runner.experiment.componets;
 ...
 */
public class GenerateFronts implements ExperimentComponent{
	public ExperimentMOCLE<?, ?> experiment;

	public GenerateFronts(ExperimentMOCLE<?, ?> experimentConfiguration) {
		this.experiment = experimentConfiguration ;

//		experiment.removeDuplicatedAlgorithms(); //removed to avoid mess with COmputeQualityIndicators
	}
	...
	public void run() throws IOException {
		...
		for (ExperimentProblem<?> problem : experiment.getProblemList()) {
			...
			for (ExperimentAlgorithmMOCLE<?,?> algorithm : experiment.getAlgorithmList()) {
