...
public abstract class CLUAbstractMOMBI<S extends Solution<?>> extends AbstractGeneticAlgorithm<S,List<S>> {
     ...
     */
    public CLUAbstractMOMBI(Problem<S> problem, int maxIterations,
