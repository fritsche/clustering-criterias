...
public class CLUMOMBI2<S extends Solution<?>> extends CLUMOMBI<S> {
     ...
     * @param pathWeights
     */
    public CLUMOMBI2(Problem<S> problem, int maxIterations, CrossoverOperator<S> crossover, MutationOperator<S> mutation,
