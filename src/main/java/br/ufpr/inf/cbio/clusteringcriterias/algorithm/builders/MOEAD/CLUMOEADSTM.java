...
//                updateNeighborhood(child, subProblemId, neighborType);
    ...
    protected void initializePopulation() {
        ...
        for (int i = 0; i < populationSize; i++) {
            ...
            savedValues[i] = (PartitionSolution) newSolution.copy();
        }
    }

    @Override
    public List<PartitionSolution> getResult() {
        return population;
    }
    ...
    public void utilityFunction() throws JMetalException {
        ...
        for (int n = 0; n < populationSize; n++) {
            ...
            savedValues[n] = (PartitionSolution) population.get(n).copy();
        }
    }
...
//        }
        selected.add(0);
        selected.add(populationSize-1); //necessary to use uniformDistribution weights, only work with 2 objectives

        for (int n = problem.getNumberOfObjectives()-1; n < populationSize-1; n++) { //necessary to use uniformDistribution weights, only work with 2 objectives
...
//        System.out.println(selected);
     ...
     * Calculate the perpendicular distance between the solution and reference line
     */
    public double calculateDistance2(PartitionSolution individual, double[] lambda) {
