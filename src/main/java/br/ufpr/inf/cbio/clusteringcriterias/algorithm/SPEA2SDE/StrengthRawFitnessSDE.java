...
public class StrengthRawFitnessSDE<S extends Solution<?>> extends GenericSolutionAttribute<S, Double> implements DensityEstimator<S> {
	...
	public void computeDensityEstimator(List<S> solutionSet) {
		double[][] distance = SPEA2SDEUtils.distanceMatrixSDE(solutionSet);
