...
# find ./ -maxdepth 1 ! -name 'concatenate.sh' ! -name 'PlotFronts.py' -type f -exec rm -fv {} \;
...
datasets=('ds2c2sc13_V1' 'ds2c2sc13_V2' 'ds2c2sc13_V3' 'ds3c3sc6_V1' 'frogs_V1' 'frogs_V2' 'frogs_V3' 'golub_V3' 'leukemia_V1' 'leukemia_V2' 'libras' 'optdigits' 'spiralsquare')
...
do
    ...
    rm -r ../../experimentResultsMCLA/testes/${dataset}_test
    mv ../tests ../../experimentResultsMCLA/testes/${dataset}_test

    #come back to .30 files folder
    cd ../../experimentResultsMCLA/Experiment0/data
